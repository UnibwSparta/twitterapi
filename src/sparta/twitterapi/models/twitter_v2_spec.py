...
#   timestamp: 2023-12-07T09:37:23+00:00
"""Manual edits:
...
constr(pattern=r"^[A-Z]{2}$") to constr(pattern=r"^[A-Za-z]{2}$")  # type: ignore
...
class MatchingRule(BaseModel):
    ...
    tag: Optional[str] = Field(None, description="A tag meant for the labeling of user provided rules.", examples=["Non-retweeted coffee Tweets"])
...
class UrlFields(BaseModel):
    ...
    display_url: Optional[str] = Field(None, description="The URL as displayed in the Twitter client.", examples=["twittercommunity.com/t/introducing-…"])
...
class Usage(BaseModel):
    ...
    project_cap: Optional[int] = Field(None, description="Total number of Tweets that can be read in this project per month")
    project_id: Optional[str] = Field(None, description="The unique identifier for this project")
    project_usage: Optional[int] = Field(None, description="The number of Tweets read in this project")
...
class Tweet(BaseModel):
    ...
    lang: Optional[str] = Field(None, description="Language of the Tweet, if detected by Twitter. Returned as a BCP47 language tag.", examples=["en"])
...
class User(BaseModel):
    ...
    subscription_type: Optional[SubscriptionType] = Field(
        None, description="The Twitter Blue subscription type of the user, eg: Basic, Premium, PremiumPlus or None."
    )
    ...
    verified_type: Optional[VerifiedType] = Field(None, description="The Twitter Blue verified type of the user, eg: blue, government, business or none.")
