...
#   timestamp: 2024-07-23T12:34:13+00:00
"""Manual edits:
...
class Space(BaseModel):
    ...
    invited_user_ids: Optional[List[constr(pattern=r"^[0-9]{1,19}$")]] = Field(  # type: ignore
    ...
    speaker_ids: Optional[List[constr(pattern=r"^[0-9]{1,19}$")]] = Field(  # type: ignore
        None, description="An array of user ids for people who were speakers in a Space."
    )
...
class Attachments1(BaseModel):
    ...
    poll_ids: Optional[List[constr(pattern=r"^[0-9]{1,19}$")]] = Field(  # type: ignore
...
class Place(BaseModel):
    ...
    country_code: Optional[constr(pattern=r"^[A-Za-z]{2}$")] = Field(  # type: ignore
        None, description="A two-letter ISO 3166-1 alpha-2 country code.", examples=["US"]
    )
...
class Tweet(BaseModel):
    ...
    edit_history_tweet_ids: Optional[List[constr(pattern=r"^[0-9]{1,19}$")]] = Field(  # type: ignore
        None, description="A list of Tweet Ids in this Tweet chain.", min_length=1
    )
